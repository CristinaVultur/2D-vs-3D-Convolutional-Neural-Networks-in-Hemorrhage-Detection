...
import os
import time
from Datasets.FiveSlices import FiveSlicesDataset
...
train_dataset = FiveSlicesDataset(merged_csv='../build/one_t3d.csv', path=sets.data_root,
...
valid_dataset = FiveSlicesDataset(merged_csv='../build/one_v3d.csv', path=sets.data_root,
                                  transform=albumentations.Compose(
                                      [albumentations.Resize(256, 256),
                                       albumentations.Normalize(mean=[0.1738], std=[0.3161],
                                                                max_pixel_value=1.),
